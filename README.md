...
app/                    --> all of the source files for the application
  ...
  language-detail/                --> the language-detail view template and logic
    language-detail.html            --> the partial template
    language-detail.js              --> the controller logic
    language-detail_test.js         --> tests of the controller
